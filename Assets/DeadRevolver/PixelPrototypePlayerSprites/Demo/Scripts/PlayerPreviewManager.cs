...
namespace DeadRevolver.PixelPrototypePlayer {
    ...
    public class PlayerPreviewManager : MonoBehaviour {
        ...
        void Update() {
            ...
            if (Keyboard.current.leftArrowKey.wasPressedThisFrame || Keyboard.current.downArrowKey.wasPressedThisFrame || Keyboard.current.aKey.wasPressedThisFrame) {
                PreviousAnimation();
            } else if (Keyboard.current.rightArrowKey.wasPressedThisFrame || Keyboard.current.upArrowKey.wasPressedThisFrame || Keyboard.current.dKey.wasPressedThisFrame) {
                NextAnimation();
            }
        }
